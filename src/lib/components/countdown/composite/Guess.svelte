...
<div class="container">
	<Number label={number_one.number} composite={number_one.composite} used={number_one.used} />
	<Operator label={operator} />
	<Number label={number_two.number} composite={number_two.composite} used={number_two.used} />
